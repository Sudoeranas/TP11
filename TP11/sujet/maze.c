...
void print_maze(maze_t const *m, char *udlr, int t[200][2], int n);    // 1
void print_mazePLEIN(maze_t const *m);                                 // 2
void print_mazePLEINchemin(maze_t const *m, T_cellule *chemin, int t); // 3
